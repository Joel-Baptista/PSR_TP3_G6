...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if not robot_to_escape_near:
            ...
            print(
                f'Red at position {round(goal_to_catch.pose.position.x, 1)},{round(goal_to_catch.pose.position.y, 1)}. Moving at speed:{round(speed, 1)}, angle:{round(angle, 1)}')
        ...
        # escape mode ******************************************
            ...
            print(
                f'Green at position {round(x_to_escape, 1)},{round(y_to_escape, 1)} go to position {round(x, 1)}, {round(y, 1)} at speed:{round(speed, 1)}, angle:{round(angle, 1)}')
