...
def main():
    ...
    pub = rospy.Publisher(cmd_vel_node, Twist, queue_size=10)
    ...
    while True:
        ...
        if not to_escape_near:
            ...
            if min_dist_to_catch == distances_to_catch[0]:
                ...
                # goal_to_catch.pose.orientation.z = z_ori_to_catch_1
            if min_dist_to_catch == distances_to_catch[1]:
                ...
                # goal_to_catch.pose.orientation.z = z_ori_to_catch_2
            if min_dist_to_catch == distances_to_catch[2]:
                ...
                # goal_to_catch.pose.orientation.z = z_ori_to_catch_3
            ...
            print(
                f'Red at position {goal_to_catch.pose.position.x},{goal_to_catch.pose.position.y}')
